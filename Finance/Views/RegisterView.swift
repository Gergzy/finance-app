...
struct RegisterView: View {
    ...
    @State private var showDatePicker: Bool = false // Controls visibility of DatePicker

    private let maxDate = Date() // Prevents selection of future dates

    var dateFormatter: DateFormatter {
        let formatter = DateFormatter()
        formatter.dateFormat = "MMMM d, yyyy" // Display format
        return formatter
    }
    ...
    var body: some View {
        ...
        .sheet(isPresented: $showDatePicker) {
            VStack {
                DatePicker("Select Your Birthday", selection: $dateOfBirth, in: ...maxDate, displayedComponents: .date) // Restricts future dates
    ...
    private func saveUserInfo(uid: String) {
        ...
        dateFormatter.dateFormat = "yyyy-MM-dd" // Formatting for database storage
